...
#ifndef RTW_HEADER_Tracker_with_Position_Control_private_h_
#define RTW_HEADER_Tracker_with_Position_Control_private_h_
#include "rtwtypes.h"
...
#endif                 /* RTW_HEADER_Tracker_with_Position_Control_private_h_ */
