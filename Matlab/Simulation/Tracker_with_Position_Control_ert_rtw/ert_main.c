...
void rt_OneStep(void)
{
  ...
  currentTime = (extmodeSimulationTime_T)
    (((Tracker_with_Position_Contro_M->Timing.clockTick0+
       Tracker_with_Position_Contro_M->Timing.clockTickH0* 4294967296.0) * 1) +
     0)
    ;
     ...
     case 2 :
      currentTime = (extmodeSimulationTime_T)
        (((Tracker_with_Position_Contro_M->Timing.clockTick2+
           Tracker_with_Position_Contro_M->Timing.clockTickH2* 4294967296.0) * 2)
         + 0)
        ;
      Tracker_with_Position_Control_step2();
...
int main(void)
{
  ...
  runModel = !extmodeSimulationComplete() && !extmodeStopRequested() &&
    !rtmGetStopRequested(Tracker_with_Position_Contro_M);
