/*
 * Tracker_with_Position_Control_ESP32.c
 *
 ...
 */
void Tracker_with_Position_Control_ESP32_SetEventsForThisBaseStep(boolean_T
  *eventFlags)
{
...
void Tracker_with_Position_Control_ESP32_step0(void) /* Sample time: [0.005s, 0.0s] */
{
...
void Tracker_with_Position_Control_ESP32_step1(void) /* Sample time: [0.01s, 0.0s] */
{
  ...
  rtb_Integrator_l = ((Tracker_with_Position_Control_P.PIDController_P *
    ...
    Tracker_with_Position_Control_P.Gain_Gain_c;
  ...
  rtb_Saturation1 = ((Tracker_with_Position_Control_P.PIDController1_P *
                     ...
                     rtb_Integrator_l) *
    Tracker_with_Position_Control_P.Gain1_Gain;
...
void Tracker_with_Position_Control_ESP32_step(int_T tid)
{
  switch (tid) {
   case 0 :
    Tracker_with_Position_Control_ESP32_step0();
    break;

   case 1 :
    Tracker_with_Position_Control_ESP32_step1();
    break;
...
void Tracker_with_Position_Control_ESP32_initialize(void)
{
  /* Registration code */
  ...
  /* External mode info */
  Tracker_with_Position_Contro_M->Sizes.checksums[0] = (172586103U);
  Tracker_with_Position_Contro_M->Sizes.checksums[1] = (3374936497U);
  Tracker_with_Position_Contro_M->Sizes.checksums[2] = (1656524246U);
  Tracker_with_Position_Contro_M->Sizes.checksums[3] = (297510280U);
...
void Tracker_with_Position_Control_ESP32_terminate(void)
{
