###########################################################################
## Makefile generated for component 'arduino_motor_encoder'. 
## 
## Makefile     : arduino_motor_encoder.mk
## Generated on : Wed Apr 22 02:32:40 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arduino_motor_encoder.elf
...
PRODUCT_NAME              = arduino_motor_encoder
MAKEFILE                  = arduino_motor_encoder.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arduino_motor_encoder.elf
...
DEFINES_STANDARD = -DMODEL=arduino_motor_encoder -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_ArduinoEncoder.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_arduino_digitalio.o xcp_ext_mode.o arduino_motor_encoder.o arduino_motor_encoder_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/arduino_motor_encoder_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/arduino_motor_encoder_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/arduino_motor_encoder_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
arduino_motor_encoder.o : $(START_DIR)/arduino_motor_encoder_ert_rtw/arduino_motor_encoder.c
	$(CC) $(CFLAGS) -o "$@" "$<"


arduino_motor_encoder_data.o : $(START_DIR)/arduino_motor_encoder_ert_rtw/arduino_motor_encoder_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/arduino_motor_encoder_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/arduino_motor_encoder_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/arduino_motor_encoder_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/arduino_motor_encoder_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
