...
void *subrateTask(void *arg)
{
  ...
  while (runModel) {
    ...
    Tracker_with_Position_ControlNoGain_ESP32_step(subRateId);
...
void *baseRateTask(void *arg)
{
  ...
  while (runModel) {
    ...
    Tracker_with_Position_ControlNoGain_ESP32_step(0);
...
void *terminateTask(void *arg)
{
  ...
  /* Terminate model */
  Tracker_with_Position_ControlNoGain_ESP32_terminate();
  extmodeReset();
...
int app_main(int argc, char **argv)
{
  ...
  /* Initialize model */
  Tracker_with_Position_ControlNoGain_ESP32_initialize();
