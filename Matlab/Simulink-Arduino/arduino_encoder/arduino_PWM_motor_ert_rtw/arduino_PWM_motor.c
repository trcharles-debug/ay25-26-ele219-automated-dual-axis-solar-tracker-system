...
void arduino_PWM_motor_step(void)
{
  ...
  /* MATLABSystem: '<S1>/ENA1' incorporates:
  ...
  /* End of MATLABSystem: '<S1>/ENA1' */

  /* MATLABSystem: '<S1>/IN1' incorporates:
  ...
  /* MATLABSystem: '<S1>/IN2' incorporates:
...
void arduino_PWM_motor_initialize(void)
{
  ...
  /* External mode info */
  arduino_PWM_motor_M->Sizes.checksums[0] = (2935286237U);
  arduino_PWM_motor_M->Sizes.checksums[1] = (1113874697U);
  arduino_PWM_motor_M->Sizes.checksums[2] = (3354378823U);
  arduino_PWM_motor_M->Sizes.checksums[3] = (2726124733U);
