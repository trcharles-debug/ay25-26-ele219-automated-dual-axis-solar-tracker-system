/*
 * File: arduino_motor_encoder_ESP32_types.h
 *
...
#ifndef RTW_HEADER_arduino_motor_encoder_ESP32_types_h_
#define RTW_HEADER_arduino_motor_encoder_ESP32_types_h_
#include "rtwtypes.h"
#include "MW_SVD.h"
...
/* Custom Type definition for MATLABSystem: '<S2>/ENA1' */
#include "MW_SVD.h"
...
typedef struct tag_4eDVzK5FiryyCjvjjvrZGB codertarget_arduinobase_int_g_T;
...
typedef struct P_arduino_motor_encoder_ESP32_T_ P_arduino_motor_encoder_ESP32_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_arduino_motor_encoder_T RT_MODEL_arduino_motor_encode_T;

#endif                     /* RTW_HEADER_arduino_motor_encoder_ESP32_types_h_ */
