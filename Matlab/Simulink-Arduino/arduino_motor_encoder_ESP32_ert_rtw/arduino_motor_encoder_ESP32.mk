###########################################################################
## Makefile generated for component 'arduino_motor_encoder_ESP32'. 
## 
## Makefile     : arduino_motor_encoder_ESP32.mk
## Generated on : Thu Apr 30 13:09:06 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arduino_motor_encoder_ESP32.elf
...
PRODUCT_NAME              = arduino_motor_encoder_ESP32
MAKEFILE                  = arduino_motor_encoder_ESP32.mk
...
SLIB_PATH                 = C:/Users/yoany/DOCUME~1/MATLAB/R2023b/ARDUIN~1/ESP32W~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arduino_motor_encoder_ESP32.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=3 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=62411 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=3 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_CONFIG_SERIAL0_=SERIAL_8N1 -D_RTT_CONFIG_SERIAL1_=SERIAL_8N1 -D_RTT_CONFIG_SERIAL2_=SERIAL_8N1 -D_RTT_TX_PIN_SERIAL0_=1 -D_RTT_RX_PIN_SERIAL0_=3 -D_RTT_TX_PIN_SERIAL1_=33 -D_RTT_RX_PIN_SERIAL1_=32 -D_RTT_TX_PIN_SERIAL2_=17 -D_RTT_RX_PIN_SERIAL2_=16 -D_RTT_ANALOG_REF_=0 -D_RTT_PWM_BLOCKS_ -DARDUINO_DEFAULT_PWM_FREQUENCY=1000
...
DEFINES_STANDARD = -DMODEL=arduino_motor_encoder_ESP32 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_ArduinoEncoder.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_arduino_digitalio.o arduino_motor_encoder_ESP32.o arduino_motor_encoder_ESP32_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o MW_ArduinoHWInit.o io_wrappers.o IPAddress.o Print.o mw_freertos_init.o mw_thread.o mw_timer.o mw_semaphore.o
...
%.o : $(START_DIR)/arduino_motor_encoder_ESP32_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/arduino_motor_encoder_ESP32_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/arduino_motor_encoder_ESP32_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/arduino_motor_encoder_ESP32_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


arduino_motor_encoder_ESP32.o : $(START_DIR)/arduino_motor_encoder_ESP32_ert_rtw/arduino_motor_encoder_ESP32.c
	$(CC) $(CFLAGS) -o "$@" "$<"


arduino_motor_encoder_ESP32_data.o : $(START_DIR)/arduino_motor_encoder_ESP32_ert_rtw/arduino_motor_encoder_ESP32_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/arduino_motor_encoder_ESP32_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/arduino_motor_encoder_ESP32_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/arduino_motor_encoder_ESP32_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
